...
try:
    ...
    pass
if True:
    local_image_main3 = pygame.image.load('image/ji_xing2.jpg')
    local_image_main2 = pygame.image.load('image/ji_xing3.png')
    move1 = False
    location_main = 212
    vel_ba = 0
    vel_bx = 0
...
def photo1(screen_shift, img1, img2):
    for alex in range(10):
        screen_shift.fill((0, 0, 0))
        img1.set_alpha(260 - alex * 16)
        screen_shift.blit(img1, (0, 0))
        img2.set_alpha(alex * 26)
        screen_shift.blit(img2, (450, 93))
        pygame.display.flip()
    flags2 = True
    while flags2:
        for event_pop in pygame.event.get():
            if event_pop.type == pygame.QUIT:
                pygame.quit()
                sys.exit(0)
            if event_pop.type == pygame.MOUSEBUTTONDOWN:
                mouse_x1, mouse_y1 = pygame.mouse.get_pos()
                if 450 < mouse_x1 < 750 and 93 < mouse_y1 < 507:
                    pass
                else:
                    flags2 = False
                    for alex in range(10):
                        screen_shift.fill((0, 0, 0))
                        img1.set_alpha(100 + alex * 25)
                        screen_shift.blit(img1, (0, 0))
                        img2.set_alpha(260 - alex * 26)
                        screen_shift.blit(img2, (450, 93))
                        pygame.display.flip()
                    screen_shift.fill((0, 0, 0))
                    img1.set_alpha(255)
                ...
                while super_super:
                    ...
                    if oiu:
                        ...
                        while cc:
                            ...
                            cc = False
                    print('\n' * 2)
            elif 895 < mouse_x < 955 and 0 < mouse_y < 110:
                flags2 = True
                stage = 0
                flags = True
                while flags2:
                    if stage == 0:
                        for i in range(10):
                            local_image_main3.set_alpha(50 * i)
                            local_image_main2.set_alpha(50 * i)
                            screen.blit(local_image_main3, (location_main, 189))
                            screen.blit(local_image_main2, (0, 0))
                            pygame.display.flip()
                        while flags:
                            for event in pygame.event.get():
                                if location_main > 212:
                                    location_main = 212
                                    screen.fill((0, 0, 0))
                                    screen.blit(local_image_main3, (location_main, 189))
                                    screen.blit(local_image_main2, (0, 0))
                                if location_main < -3688:
                                    location_main = -3688
                                    screen.fill((0, 0, 0))
                                    screen.blit(local_image_main3, (location_main, 189))
                                    screen.blit(local_image_main2, (0, 0))
                                ...
                                if event.type == pygame.MOUSEBUTTONDOWN:
                                    mouse_x, mouse_y = pygame.mouse.get_pos()
                                    if 1120 < mouse_x < 1200 and 0 < mouse_y < 80:
                                        stage = -1
                                        flags2 = False
                                        flags = False
                                        break
                                    elif 210 < mouse_x < 1015 and 185 < mouse_y < 530:
                                        move1 = True
                                        vel_bx = location_main
                                        vel_ba, vel_bb = pygame.mouse.get_pos()
                                    elif 630 < mouse_x < 690 and 0 < mouse_y < 70:
                                        stage = 2
                                        flags = False
                                        break
                                vel_bc, vel_bd = pygame.mouse.get_pos()
                                if event.type == pygame.MOUSEBUTTONUP:
                                    if move1:
                                        move1 = False
                                        location_main = -(vel_ba - vel_bx) + vel_bc
                                        vel_ba = 0
                                        vel_bx = 0
                                        if location_main > 212:
                                            location_main = 212
                        ...
                        ji_xing_img = pygame.image.load('image/ji_xing.jpg')
                        for i in range(10):
                            ji_xing_img.set_alpha(50 * i)
                            screen.blit(ji_xing_img, (0, 0))
                            pygame.display.flip()
                        while flags:
                            for event in pygame.event.get():
                                if event.type == pygame.MOUSEBUTTONDOWN:
                                    ...
                                    if 1120 < mouse_x < 1200 and 0 < mouse_y < 80:
                                        ...
                                        flags = False
                                        break
                                    elif 120 < mouse_x < 200 and 325 < mouse_y < 415:
                                        object_image_pop = pygame.image.load('image/黑剑.jpg')
                                        photo1(screen, ji_xing_img, object_image_pop)
                                    elif 270 < mouse_x < 335 and 325 < mouse_y < 415:
                                        object_image_pop = pygame.image.load('image/匣里日月.jpg')
                                        photo1(screen, ji_xing_img, object_image_pop)
                                    elif 200 < mouse_x < 270 and 325 < mouse_y < 415:
                                        object_image_pop = pygame.image.load('image/螭骨剑.jpg')
                                        photo1(screen, ji_xing_img, object_image_pop)
                                    elif 335 < mouse_x < 405 and 325 < mouse_y < 415:
                                        object_image_pop = pygame.image.load('image/苍翠猎弓.jpg')
                                        photo1(screen, ji_xing_img, object_image_pop)
                                    elif 405 < mouse_x < 480 and 325 < mouse_y < 415:
                                        object_image_pop = pygame.image.load('image/决斗之枪.jpg')
                                        photo1(screen, ji_xing_img, object_image_pop)
                    elif stage == 3:
                        pass
                    flags = True
